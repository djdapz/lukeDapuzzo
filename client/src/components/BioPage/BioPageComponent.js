        ...
        return (
            ...
            <div id="bio-page" className="main-content">
                <p>
                    ...
                    of genres to create a new sound of my own. Over the past few years I have been recording all of my
                    own songs on Ableton live playing the guitar, drums, bass, piano and singing my own tracks then
                    mixing them together.
                </p>

                <p>
                    Currently I've been trying to make a name for myself and am constantly writing new music. I always
                    wanted to be a musician for a profession and want my music to be heard and inspire the people who
                ...
                <p>
                    Influences: David Bowie, My Chemical Romance, The Beatles, Green Day, Pierce the Veil, Frank Iero,
